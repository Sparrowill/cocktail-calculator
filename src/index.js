...
function generateShoppingList(title, tableRows, totalIngredientCost, date)
{
    ...
    currentY += 20
    doc.text("Due to a combination of environmental concerns and issues with paper straws, we no longer", 45, currentY)
    currentY += 13
    doc.text(" supply straws as part of our equipment. We will happily use any straws you provide us.", 45, currentY)
